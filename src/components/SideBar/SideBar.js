...
import DarkModeOutlinedIcon from '@mui/icons-material/DarkModeOutlined';import { Link } from 'react-router-dom';
    ...
    return (
        <ThemeProvider theme={theme}>
          ...
          >
                ...
                {buttonComponent("/settings", <SettingsIcon fontSize="3rem" />, "Settings")}
              </Box>
            )}
          </AppBar>
        </ThemeProvider>
